"""
Inference Script for RGB Model
...
def compare_models(image_path, models_dir='./models'):
    ...
    if len(model_files) == 0:
        print("No trained models found. Please run train_rgb_model.py first.")
        return
...
def main():
    ...
    if args.compare:
        ...
        if not model_path.exists():
            ...
            print("Please run train_rgb_model.py first or use --compare to see available models")
            return
